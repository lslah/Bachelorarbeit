...
Wir beginnen mit einer oberen Schranke der Zeilensummennorm inverser
Vandermonde-Matrizen und orientieren uns dabei uns an der Beweisskizze aus
...
Jensens Formel liefert eine Aussage über analytische Funktionen $f$, die unter
anderem $f(0) \neq 0$ erfüllen müssen.
Diese Voraussetzung wird jedoch verletzt, wenn man $0$ als Stützstelle der
Vandermonde-Matrix wählt.
...
\noindent Unter Verwendung von Jensens Formel aus Satz \ref{thm:jensens_formula} beweisen
