...
%
    ...
    \begin{equation*}
        \begin{split}
            ...
            &= e^{k\cdot i\varphi} \sum_{1 \leq j_1 < \dots < j_k \leq n-1} r_{j_1} \cdots r_{j_k}
        \end{split}
    \end{equation*}
    und
    \begin{equation*}
        \begin{split}
            ...
            &= \sum_{1 \leq j_1 < \dots < j_{k-1} \leq n-1} r_n e^{i\varphi} \cdot r_{j_1} e^{i\varphi} \cdots r_{j_k} e^{i\varphi}\\
            &= e^{k\cdot i\varphi} \sum_{1 \leq j_1 < \dots < j_{k-1} \leq n-1} r_n \cdot r_{j_1} \cdots r_{j_k}
        \end{split}
    \end{equation*}
