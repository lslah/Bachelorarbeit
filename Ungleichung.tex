...
%
    ...
    \noindent Es bleibt die Aussage über die Gleichheit von Gleichung
    (\ref{eq:elementary_symmetric_polynomials_inequality}) zu beweisen.
    Dazu stellen wir fest, dass Gleichheit genau dann gilt, wenn in der
    Dreiecksungleichung (\ref{eq:elementary_polynomials_inequality_proof})
    Gleichheit gilt, also genau dann, wenn für alle $k = 1, \dots, n$
    \[
